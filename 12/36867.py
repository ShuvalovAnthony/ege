for edinici in range(1, 50):
    for dvoiki in range(1, 50):
        for troiki in range(1, 50):
            ishod_str = '0' + '1'*edinici + \
                '2'*dvoiki + '3'*troiki + '0'
            ...
            if (
                (ishod_str.count('1') == 26) and
                (ishod_str.count('2') == 54) and
                (ishod_str.count('3') == 48)
            ):
